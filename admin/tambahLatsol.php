...
if (isset($_POST["tambah"])) {
	...
	$check = mysqli_query(
		$conn,
		"INSERT INTO latihan_soal (id_matkul, judul, link_file)
    ...
    ";
		...
		echo "
    <script>
    alert('Latihan soal gagal ditambahkan!');
    window.history.back();
    </script>
    ";
	}
                ...
                <form action="" method="POST">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" name="judul" placeholder="Masukkan judul soal" required>
                        </div>
