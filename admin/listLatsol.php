...
cekSession();
$allLatsol = query("SELECT * FROM latihan_soal");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="main">
            ...
            <div class="list">
                <div class="containerlist">
                    <h1>List Latihan Soal</h1>
                    <?php foreach ($allLatsol as $item): ?>
                    <div class="box">
                        <h3><?= $item["judul"] ?></h3>
                        <div class="button">
                            <a href="editLatsol.php?id=<?= $item[
                            	"id_latsol"
                            ] ?>">Edit</a>
                            <a onclick="return confirm('Apakah kamu yakin akan menghapus mata kuliah ini?')" href="deleteData.php?type=latsol&id=<?= $item[
                            	"id_latsol"
                            ] ?>">Hapus</a>
                        </div>
                    </div>
