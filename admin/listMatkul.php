...
cekSession();
$allMatkul = query("SELECT * FROM mata_kuliah");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="main">
            ...
            <div class="list">
                <div class="containerlist">
                    ...
                    <?php foreach ($allMatkul as $item): ?>
                    <div class="box">
                        <h3><?= $item["nama_matkul"] ?></h3>
                        <div class="button">
                            <a href="editMatkul.php?id=<?= $item[
                            	"id_matkul"
                            ] ?>">Edit</a>
                            <a onclick="return confirm('Apakah kamu yakin akan menghapus mata kuliah ini?')" href="deleteData.php?type=matkul&id=<?= $item[
                            	"id_matkul"
                            ] ?>">Hapus</a>
                        </div>
                    </div>
